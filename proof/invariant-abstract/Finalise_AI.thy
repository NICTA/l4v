...
crunch cte_wp_at[wp]: fast_finalise "cte_wp_at P p"
  (wp:fast_finalise_lift maybeM_inv mapM_x_wp ignore: set_tcb_obj_ref)
...
lemma cap_delete_one_deletes_reply:
  "\<lbrace>cte_wp_at (op = (cap.ReplyCap t)) slot and valid_reply_caps\<rbrace>
    cap_delete_one slot
...
lemma cap_delete_one_reply_st_tcb_at:
  "\<lbrace>pred_tcb_at proj P t and cte_wp_at (op = (cap.ReplyCap t')) slot\<rbrace>
    cap_delete_one slot
